...
public class Pizza {
    ...
    public static void main(String[] args) {
        ...
        while (lol == 0) {
            ...
            // created an array to copy topping user entered
            String[][] storeToppings = new String[5][5];
            ...
            switch (opt) {
                case 1:
                    ...
                    PizzaDetails details = new PizzaDetails(topping, sizeOfPizza);
                    ...
                    for (int i = 0; i < pizza.length; i++) {
                        ...
                        System.out.println("Maximum 5 allowed");
                        ...
                        // creating array to store toppings
                        String[] pizzaTop = new String[numberOfTopping];

                        //populating array
                        // for loop because each pizza will have multiple toppings 
                        for (int j = 0; j < pizzaTop.length; j++) {
                            ...
                            details.setTopping(topping);

                            pizzaTop[j] = details.getTopping();

                            storeToppings[i][j] = pizzaTop[j];
                        }
                        ...
                        switch (choice) {
                            case 1:
                                ...
                                for (int i = 0; i < pizza.length; i++) {
                                    ...
                                    for (int j = 0; j < numberOfTopping; j++) {
                                        System.out.printf("-%s\n", storeToppings[i][j]);
                                    }
                                }
